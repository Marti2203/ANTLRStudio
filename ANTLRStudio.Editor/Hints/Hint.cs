...
namespace ANTLRStudio.Editor.Hints
{
    /// <summary>
    ...
    public class Hint
    {
        ...
        /// Backcolor
        /// </summary>
        public Color BackColor { get { return HostPanel.BackgroundColor; } set { HostPanel.BackgroundColor = value; } }
        /// <summary>
        /// Second backcolor
        /// </summary>
        ...
        /// Fore color
        /// </summary>
        public Color ForeColor { get { return HostPanel.ForegroundColor; } set { HostPanel.ForegroundColor = value; } }
        /// <summary>
        /// Text alignment
        /// </summary>
        ...
        {
            add { HostPanel.MouseDown += value; }
            remove { HostPanel.MouseDown -= value; }
        }
        /// <summary>
        /// Inner control
        /// </summary>
        ...
        {
            HostPanel = new UnfocusablePanel(Colors.White);
            HostPanel.MouseDown += OnClick;
