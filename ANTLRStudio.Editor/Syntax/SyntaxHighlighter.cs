...
using Style = ANTLRStudio.Editor.Styles.Style;
...
namespace ANTLRStudio.Editor.Syntax
{
    ...
    {
        //styles
        public readonly TextStyle BlueBoldStyle = new TextStyle(Brushes.Blue, null, FontStyle.Bold);
        public readonly TextStyle BlueStyle = new TextStyle(Brushes.Blue, null, FontStyle.None);
        public readonly TextStyle BoldStyle = new TextStyle(null, null, FontStyle.Bold);
        public readonly TextStyle BrownStyle = new TextStyle(Brushes.Brown, null, FontStyle.Italic);
        public readonly TextStyle GrayStyle = new TextStyle(Brushes.Gray, null, FontStyle.None);
        public readonly TextStyle GreenStyle = new TextStyle(Brushes.Green, null, FontStyle.Italic);
        public readonly TextStyle MagentaStyle = new TextStyle(Brushes.Magenta, null, FontStyle.None);
        public readonly TextStyle MaroonStyle = new TextStyle(Brushes.Maroon, null, FontStyle.None);
        public readonly TextStyle RedStyle = new TextStyle(Brushes.Red, null, FontStyle.None);
        public readonly TextStyle BlackStyle = new TextStyle(Brushes.Black, null, FontStyle.None);
        //
        ...
        protected void VBAutoIndentNeeded(object sender, AutoIndentEventArgs args)
        {
            ...
            //Char _
            if (args.PrevLineText.TrimEnd().EndsWith("_", StringComparison.InvariantCultureIgnoreCase))
            {
                args.Shift = args.TabLength;
                return;
            }
        ...
        public virtual void AddResilientStyle(Styles.Style style)
        {
        ...
        protected static Styles.Style ParseStyle(XmlNode styleNode)
        {
        ...
        protected static Color ParseColor(string s)
        {
            if (s.StartsWith("#", StringComparison.InvariantCultureIgnoreCase))
            {
                if (s.Length <= 7)
                {
                    var color = Color.FromArgb(int.Parse(s.Substring(1), NumberStyles.AllowHexSpecifier));
                    color.Ab = 255;
                    return color;
                }
                return Color.FromArgb(int.Parse(s.Substring(1), NumberStyles.AllowHexSpecifier));
            }
            return (Color)typeof(Colors).GetProperty(s).GetValue(null);
        }
