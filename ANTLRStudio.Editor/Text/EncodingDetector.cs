...
namespace ANTLRStudio.Editor.Text
{
    public static class EncodingDetector
    {
        ...
        public static Encoding DetectTextFileEncoding(FileStream InputFileStream, long HeuristicSampleSize) => DetectTextFileEncoding(InputFileStream, _defaultHeuristicSampleSize, out bool uselessBool);
