...
namespace ANTLRStudio.TreeLayout
{
    ...
    public abstract class Configuration<TreeNode>
    {
         ...
         */
        public Location RootLocation { get; protected set; }
         ...
         */
        public AlignmentInLevel Alignment { get; protected set; }
         ...
         *         [result &gt;= 0]
         */
        public abstract float GapBetweenLevels(int nextLevel);
         ...
         */
        public abstract float GapBetweenNodes(TreeNode nodeOne, TreeNode nodeTwo);
    }
}
